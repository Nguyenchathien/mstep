...
define("WEATHER_WEB_URL","https://weather.yahoo.co.jp/weather/");
/**
 * Email to test function send schedule report by email
 * Make sure constant is a array, each email is a item
 */
define('TEST_EMAIL_TO',array('hien.nguyen@spc-vn.com'));
...
/** Define the path to email content for function send schedule report of all - by Edward */
define('SCHEDULE_REPORT_CONTENT_PATH', WWW_ROOT.DS.'files'.DS.'contents'. DS . CLIENT);

/** Define the path to get all email content for function send schedule report of all - by Hien Nguyen */
define('ALL_SCHEDULE_REPORT_CONTENT_PATH', WWW_ROOT.DS.'files'.DS.'contents');
 ...
 * @author Edward <hien.nguyen@spc-vn.com>
 * @date 2016-12-21
 */
...
$email['local']['returnPath']="hien.nguyen@spc-vn.com";
$email['local']['to']="hien.nguyen@spc-vn.com";
